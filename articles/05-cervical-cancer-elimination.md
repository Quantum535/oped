...
Screening no longer requires a pelvic exam, a clinician, or even a clinic. WHO-recommended HPV self-sampling lets a woman collect her own swab in minutes, which converts screening from a scarce clinical service into something closer to a distribution problem. And for women who test positive, portable thermal ablation devices now allow a trained nurse to treat most precancerous lesions the same day, in the same room, with no referral and no loss to follow-up.

Every major input has fallen sharply: a single dose instead of two, a self-collected swab instead of a clinic visit, one treatment session instead of a referral chain. And the same Lancet models show what the full toolkit buys: adding twice-lifetime screening to vaccination reaches elimination in all 78 countries, not 60 percent of them, and pulls the date forward by 11 to 31 years. The science was never the obstacle. Now the economics is not either.
...
That is the remaining gap, and it is a gap of financing structure, not technology. A Lancet Global Health review of 202 countries found that just 9 to 11 percent of women in low- and lower-middle-income countries have ever been screened for cervical cancer, against 84 percent in high-income countries. The places furthest behind are precisely the ones without an organized screening program actually operating, whatever their paper policies say.
...
6. World Health Organization. "Global strategy to accelerate the elimination of cervical cancer as a public health problem." Geneva: WHO; 2020. https://www.who.int/publications/i/item/9789240014107
